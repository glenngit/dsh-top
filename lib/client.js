...
window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		function Monitor() {
			...
			// CSS lives for the whole mount so the collapsed frame still renders
			// correctly when reopened. Only the polling timer toggles with `open`.
			useEffect(() => {
			...
			// Remove injected CSS only when the component truly unmounts.
			useEffect(() => () => {
				const style = document.querySelector('style[data-plugin="dsh-top"]');
